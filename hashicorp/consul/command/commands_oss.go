...
import (
	"github.com/as/consulrun/hashicorp/consul/command/agent"
	"github.com/as/consulrun/hashicorp/consul/command/catalog"
	catlistdc "github.com/as/consulrun/hashicorp/consul/command/catalog/list/dc"
	catlistnodes "github.com/as/consulrun/hashicorp/consul/command/catalog/list/nodes"
	catlistsvc "github.com/as/consulrun/hashicorp/consul/command/catalog/list/services"
	"github.com/as/consulrun/hashicorp/consul/command/event"
	"github.com/as/consulrun/hashicorp/consul/command/exec"
	"github.com/as/consulrun/hashicorp/consul/command/forceleave"
	"github.com/as/consulrun/hashicorp/consul/command/info"
	"github.com/as/consulrun/hashicorp/consul/command/join"
	"github.com/as/consulrun/hashicorp/consul/command/keygen"
	"github.com/as/consulrun/hashicorp/consul/command/keyring"
	"github.com/as/consulrun/hashicorp/consul/command/kv"
	kvdel "github.com/as/consulrun/hashicorp/consul/command/kv/del"
	kvexp "github.com/as/consulrun/hashicorp/consul/command/kv/exp"
	kvget "github.com/as/consulrun/hashicorp/consul/command/kv/get"
	kvimp "github.com/as/consulrun/hashicorp/consul/command/kv/imp"
	kvput "github.com/as/consulrun/hashicorp/consul/command/kv/put"
	"github.com/as/consulrun/hashicorp/consul/command/leave"
	"github.com/as/consulrun/hashicorp/consul/command/lock"
	"github.com/as/consulrun/hashicorp/consul/command/maint"
	"github.com/as/consulrun/hashicorp/consul/command/members"
	"github.com/as/consulrun/hashicorp/consul/command/monitor"
	"github.com/as/consulrun/hashicorp/consul/command/operator"
	operauto "github.com/as/consulrun/hashicorp/consul/command/operator/autopilot"
	operautoget "github.com/as/consulrun/hashicorp/consul/command/operator/autopilot/get"
	operautoset "github.com/as/consulrun/hashicorp/consul/command/operator/autopilot/set"
	operraft "github.com/as/consulrun/hashicorp/consul/command/operator/raft"
	operraftlist "github.com/as/consulrun/hashicorp/consul/command/operator/raft/listpeers"
	operraftremove "github.com/as/consulrun/hashicorp/consul/command/operator/raft/removepeer"
	"github.com/as/consulrun/hashicorp/consul/command/reload"
	"github.com/as/consulrun/hashicorp/consul/command/rtt"
	"github.com/as/consulrun/hashicorp/consul/command/snapshot"
	snapinspect "github.com/as/consulrun/hashicorp/consul/command/snapshot/inspect"
	snaprestore "github.com/as/consulrun/hashicorp/consul/command/snapshot/restore"
	snapsave "github.com/as/consulrun/hashicorp/consul/command/snapshot/save"
	"github.com/as/consulrun/hashicorp/consul/command/validate"
	"github.com/as/consulrun/hashicorp/consul/command/version"
	"github.com/as/consulrun/hashicorp/consul/command/watch"
	consulversion "github.com/as/consulrun/hashicorp/consul/version"
