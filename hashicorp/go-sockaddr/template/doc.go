...
through its Parse() call.  For example:
    ...
    import (
      ...
      template "github.com/as/consulrun/hashicorp/go-sockaddr/template"
    )
...
https://github.com/as/consulrun/hashicorp/go-sockaddr/tree/master/cmd/sockaddr utility for
